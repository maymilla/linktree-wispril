...
export default function Home() {
  ...
  return (
    <div className="shadow-inner bg-gradient-to-tr fgitrom-rose-800 to-amber-200 p-8 grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
